...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        if (Robot.isReal()) {
            algaeVisualizer = new GamePieceVisualize("Algae Visualizer", 0, 0, new Pose3d[0], new Pose3d[0]);
            coralVisualizer = new GamePieceVisualize("Coral Visualizer", 0, 0, new Pose3d[0], new Pose3d[0]);
        ...
        robotCommand = new RobotCommandFactory(swerve, intake, arm, climber, endeffector, nodeSelector, odometry);
    ...
    void configureCommandBinding() {
        ...
        Map<Trigger, Entry<Integer, Boolean>> coralScoreTriggers = Map.ofEntries(
