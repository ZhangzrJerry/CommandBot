        ...
        void configureCommandBinding() {
                ...
                joystick
                                ...
                                .onTrue(
                                                Commands.runOnce(
                                                                () -> {
                                                                        Boolean isAlgaeHighPick = ReefScape.PoseUtils
                                                                                        .isAlgaeHighPick(swerve
                                                                                                        .getPose());
                                                                        SmartDashboard.putBoolean("isAlgaeHighPick",
                                                                                        isAlgaeHighPick);
                                                                        superStructure.algaeReefPickCmd(
                                                                                        isAlgaeHighPick);
                                                                }));
                joystick
                                .rightBumper()
                                ...
                                .whileTrue(
                                                Commands.runOnce(
                                                                () -> SmartDashboard.putBoolean(
                                                                                "asdf",
                                                                                ReefScape.PoseUtils.isAlgaeHighPick(
                                                                                                swerve.getPose()))));
        }
