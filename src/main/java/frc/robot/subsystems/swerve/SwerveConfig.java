...
public class SwerveConfig {
    ...
    protected static final TunableNumber currentRampFactor = new TunableNumber("KsCharacterization/CurrentRampPerSec",
            1.0);
    protected static final TunableNumber minVelocity = new TunableNumber("KsCharacterization/MinStaticVelocity", 0.1);
    protected static final TunableNumber characterizationSpeedDegreePerSec = new TunableNumber(
            "Swerve/WheelRadiusCharacterization/SpeedDegreePerSec", 360.0);
    ...
    static TunablePidsgGains DRIVE_GAINS = new TunablePidsgGains(
            "Swerve/Module/DriveGains",
            Robot.isReal() ? new GainsImpl(7.0, 0.0, 0.0, 0.0, 0.0) : new KpGainsImpl(0.3));
    static TunablePidsgGains STEER_GAINS = new TunablePidsgGains(
