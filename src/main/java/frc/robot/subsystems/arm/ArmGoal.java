...
public class ArmGoal extends TunableNumbers {
    ...
    public static final ArmGoal CORAL_L1_SCORE = new ArmGoal("Arm/Goal/CoralL1Score", 0.4 - 0.04, -32.0);
    public static final ArmGoal CORAL_L2_SCORE = new ArmGoal("Arm/Goal/CoralL2Score", 0.64 - 0.04, -32.0);
    public static final ArmGoal CORAL_L3_SCORE = new ArmGoal("Arm/Goal/CoralL3Score", 1.06 - 0.04, -34.0);
    public static final ArmGoal CORAL_L4_SCORE = new ArmGoal("Arm/Goal/CoralL4Score", 1.7 - 0.04, -34.0);
    public static final ArmGoal CORAL_STATION_COLLECT = new ArmGoal("Arm/Goal/CoralStationCollect", 0.01, -232.0);
    ...
    public static final ArmGoal ALGAE_AUTO_LOW_PICK = new ArmGoal("Arm/Goal/AlgaeAutoLowPick", 0.5, -90.0);
    public static final ArmGoal ALGAE_AUTO_HIGH_PICK = new ArmGoal("Arm/Goal/AlgaeAutoHighPick", 0.7, -90.0);
    ...
    public static final ArmGoal ALGAE_GROUND_PICK = new ArmGoal("Arm/Goal/AlgaeGroundPick", 0.25, 45.0);
}
