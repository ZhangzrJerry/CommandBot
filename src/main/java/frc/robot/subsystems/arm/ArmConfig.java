...
class ArmConfig {
    ...
    protected static final TunableNumber TRANSITION_ELEVATOR_HEIGHT_METER = new TunableNumber(
            "Arm/TransitionElevatorHeightMeter", 0.38);
    protected static final TunableNumber MIN_SAFE_GROUND_INTAKE_DODGE_ELEVATOR_HEIGHT_METER = new TunableNumber(
            "Arm/MinSafeGroundIntakeDodgeElevatorHeightMeter", 0.65);

    // Shoulder joint configuration
    protected static final TunableNumber SHOULDER_TOLERANCE_METER = new TunableNumber("Arm/Shoulder/ToleranceMeter",
            0.1);
    protected static final TunableNumber SHOULDER_STOP_TOLERANCE_METER_PER_SEC = new TunableNumber(
            "Arm/Shoulder/StopToleranceMeterPerSec", 0.1);
    protected static final TunableNumber SHOULDER_STATIC_CHARACTERIZATION_VELOCITY_THRESH_METER_PER_SEC = new TunableNumber(
            "Arm/Shoulder/StaticCharacterizationVelocityThreshMeterPerSec", 0.01);
    protected static final TunableNumber SHOULDER_HOMING_CURRENT_AMP = new TunableNumber(
            "Arm/Shoulder/HomingCurrentAmp", -3.0);
    protected static final TunableNumber SHOULDER_HOMING_TIME_SECS = new TunableNumber("Arm/Shoulder/HomingTimeSecs",
            0.2);
    protected static final TunableNumber SHOULDER_HOMING_VELOCITY_THRESH_METER_PER_SEC = new TunableNumber(
            "Arm/Shoulder/HomingVelocityThreshMeterPerSec", 0.05);

    // Elbow joint configuration
    protected static final TunableNumber ELBOW_TOLERANCE_DEGREE = new TunableNumber("Arm/Elbow/ToleranceDegree", 12.0);
    protected static final TunableNumber ELBOW_STOP_TOLERANCE_DEGREE_PER_SEC = new TunableNumber(
            "Arm/Elbow/StopToleranceDegreePerSec", 10.0);
    protected static final TunableNumber ELBOW_STATIC_CHARACTERIZATION_VELOCITY_THRESH_DEGREE_PER_SEC = new TunableNumber(
            "Arm/Elbow/StaticCharacterizationVelocityThreshDegreePerSec", 10.0);
    protected static final TunableNumber ELBOW_AVOID_REEF_ALGAE_POSITION_DEGREE = new TunableNumber(
    ...
    static final double SHOULDER_SINGLE_LEVEL_HEIGHT_METER = SHOULDER_MAX_HEIGHT_METER * SHOULDER_HEIGHT_RATIO;
    ...
    protected static final TunablePidsgGains ELBOW_GAINS = new TunablePidsgGains(
            "Arm/Elbow/Gains",
            Robot.isReal() ? new GainsImpl(450.0, 0.0, 73.0, 8.0, 0.0) : new KpdGainsImpl(3.0, 0.3));

    protected static final TunablePidsgGains SHOULDER_GAINS = new TunablePidsgGains(
            "Arm/Shoulder/Gains",
