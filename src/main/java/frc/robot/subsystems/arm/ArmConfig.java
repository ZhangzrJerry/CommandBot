...
class ArmConfig {
  ...
  public static CANcoderConfiguration getCancoderConfig(double magnetOffset) {
  ...
  public static final Transform3d L2_ZEROED_TF =
      new Transform3d(0., 0, 0, new Rotation3d(Math.PI / 2, 0, Math.PI / 2));
  public static final Transform3d L3_ZEROED_TF = new Transform3d();
  public static final Transform3d L4_ZEROED_TF = new Transform3d();
  public static final Transform3d ARM_ZEROED_TF =
      new Transform3d(
          0,
          0.5,
          0.,
