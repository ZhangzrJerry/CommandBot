...
class ArmConfig {
  ...
  protected static final TunableNumber shoulderToleranceMeter = new TunableNumber("Arm/Shoulder/ToleranceMeter", 0.1);
  ...
  protected static final TunableNumber shoulderHomingCurrentAmp = new TunableNumber("Arm/Shoulder/HomingCurrentAmp",
      -8.0);
  protected static final TunableNumber shoulderHomingTimeSecs = new TunableNumber("Arm/Shoulder/HomingTimeSecs", 0.6);
  ...
  protected static final TunableNumber elbowToleranceDegree = new TunableNumber("Arm/Elbow/ToleranceDegree", 12.0);
  ...
  protected static TunablePidsgGains ELBOW_GAINS = new TunablePidsgGains("Arm/Elbow/Gains", 450.0, 0.0, 73.0, 8.0, 0.0);
  ...
  protected static TunablePidsgGains SHOULDER_GAINS = new TunablePidsgGains("Arm/Shoulder/Gains", 225, 0.0, 30.0, 24.0,
      38);
  ...
  protected static final Transform3d ARM_ZEROED_TF = new Transform3d(
      ...
      new Rotation3d(new Quaternion(0.990691, -0.136134, -3.02277e-17, -3.02277e-17))
          .plus(new Rotation3d(Units.degreesToRadians(-73.5), 0, 0)));
}
